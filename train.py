...
from models.common import BiFPN_Add3, BiFPN_Add2, BiFPN_Concat2, BiFPN_Concat3
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5n-Ghostconv-C3Ghost-BiFPN_Concat-CBAMC3.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/ves.yaml', help='dataset.yaml path')
...
def main(opt, callbacks=Callbacks()):
    ...
    # Evolve hyperparameters (optional)
        ...
        #evolve_csv_utf8=  save_dir / 'evolve_utf8.csv'
        #CSV_2_UTF8(evolve_csv, evolve_csv_utf8)
